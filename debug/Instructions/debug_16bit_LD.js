...
cpu.mmu.writeWord(cpu.pc + 1, value);
...
console.log(
  "    Value at address 0x" +
    value.toString(16) +
    ": 0x" +
    cpu.mmu.readByte(value).toString(16)
);
console.log(
  "    Value at address 0x" +
    (value + 1).toString(16) +
    ": 0x" +
    cpu.mmu.readByte(value + 1).toString(16)
);
...
console.log(
  "    Value at address 0x" +
    ...
    ": 0x" +
    cpu.mmu.readByte(cpu.sp - 2).toString(16)
);
console.log(
  "    Value at address 0x" +
    (cpu.sp - 1).toString(16) +
    ": 0x" +
    cpu.mmu.readByte(cpu.sp - 1).toString(16)
);
instruction.push("BC");
console.log(
  "    PUSH nn : Addr. 0x" +
    cpu.sp.toString(16) +
    "=0x" +
    cpu.mmu.readByte(cpu.sp).toString(16)
);
console.log(
  "              Addr. 0x" +
    (cpu.sp + 1).toString(16) +
